...
This example is based on [TestPBREdgeTint.cxx](https://gitlab.kitware.com/vtk/vtk/-/blob/master/Rendering/OpenGL2/Testing/Cxx/TestPBREdgeTint.cxx) and renders spheres with different edge colors using a skybox as image based lighting.
