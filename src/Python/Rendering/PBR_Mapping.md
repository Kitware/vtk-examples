...
This example is based on [TestPBRMapping.cxx](https://gitlab.kitware.com/vtk/vtk/-/blob/master/Rendering/OpenGL2/Testing/Cxx/TestPBRMapping.cxx) and renders spheres with different edge colors using a skybox as image based lighting.
