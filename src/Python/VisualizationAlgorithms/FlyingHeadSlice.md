...
This example is a modification of [HeadSlice](../../../Cxx/VisualizationAlgorithms/HeadSlice) using vtkFlyingEdges2D for contouring. However there is an option to use vtkContourFilter instead.
