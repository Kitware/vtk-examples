...
def main():
    ...
    available_surfaces = {'torus', 'parametrictorus', 'randomhills'}
...
def make_torus():
    ...
    cleaner.Update()
    return make_elevations(cleaner.GetOutput())
...
def make_glyphs(src, reverseNormals):
    """
