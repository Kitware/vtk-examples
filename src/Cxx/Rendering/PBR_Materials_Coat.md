...
This example is based on [TestPBRMaterialsCoat.cxx](https://gitlab.kitware.com/vtk/vtk/-/blob/master/Rendering/OpenGL2/Testing/Cxx/TestPBRMaterialsCoat.cxx) and renders spheres with different coat materials using a skybox as image based lighting.
